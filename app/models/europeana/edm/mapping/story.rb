    ...
    module Mapping
      ...
      class Story < Base
        ...
        def provided_cho
          ...
          graph << [ uri, RDF::DCElement.type, RDF::Literal.new("Story", :language => :en) ]
        ...
        def child_items
          ...
          # If they have rich metadata, they get their own ore:Aggregation,
          # so should not be nested.
          unless @source.attachments_have_rich_metadata?
