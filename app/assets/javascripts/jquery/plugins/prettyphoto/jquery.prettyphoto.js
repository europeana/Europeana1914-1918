			...
			$pp_pic_holder.fadeIn(function(){
				...
				switch(_getFileType(pp_images[set_position])){
					...
					case 'vimeo':
						...
						// updating the vimeo regexp to the latest recommended vimeo video url
						//var regExp = /http:\/\/(www\.)?vimeo.com\/(\d+)/;
						var regExp = /\/\/(www\.)?player.vimeo.com\/video\/(\d+)/;
		...
		*/
		function _showContent(){
			...
			$pp_pic_holder.animate({
				...
				// Callback!
				// setting this to the pp_pic_holder so that any custom modifications can be carried out
				settings.changepicturecallback.call(this);
