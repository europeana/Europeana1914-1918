	...
	RunCoCo.uploadify = {
		...
		setOptions : function() {
			...
			this.options = {
				...
				uploader				: RunCoCo.relativeUrlRoot + '/assets/full/javascripts/com/jquery/plugins/uploadify/2.1.4/uploadify.swf',
				script					: RunCoCo.uploadify_settings.script,
				multi						: true, 
				cancelImg				: RunCoCo.relativeUrlRoot + '/assets/full/javascripts/com/jquery/plugins/uploadify/2.1.4/cancel.png',
