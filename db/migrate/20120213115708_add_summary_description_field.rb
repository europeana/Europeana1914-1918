class AddSummaryDescriptionField < ActiveRecord::Migration
  OLD_ORDER = {
  ...
  def self.up
    MetadataField.create(:name => 'summary', :field_type => 'text', :title => "Summary description of items", :cataloguing => false, :contribution => true, :attachment => false, :searchable => false, :required => false, :show_in_listing => false)
  ...
  def self.down
    MetadataField.find_by_name('summary').destroy
