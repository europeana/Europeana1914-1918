...
{ :sk => {
    ...
    :countries => {
			:AC => "Ostrov Ascensión; [draft=contributed]",
			:AD => "Andorra",
			...
			:CD => "Kongo [DRK]; [draft=contributed]",
			:CF => "Stredoafrická republika",
			:CG => "Kongo",
			:CG => "Kongo [republika]; [draft=contributed]",
			:CH => "Švajčiarsko",
			:CI => "Pobrežie Slonoviny",
			:CI => "Pobrežie Slonoviny; [draft=contributed]",
			:CK => "Cookove ostrovy",
			:CL => "Čile",
			:CM => "Kamerun",
			:CN => "Čína",
			:CO => "Kolumbia",
			:CP => "Ostrov Clipperton; [draft=contributed]",
			:CR => "Kostarika",
			:CU => "Kuba",
			:CV => "Kapverdy",
			:CW => "Curaçao",
			...
			:DZ => "Alžírsko",
			:EA => "Ceuta a Melilla; [draft=contributed]",
			:EC => "Ekvádor",
			:EE => "Estónsko",
			:EG => "Egypt",
			:EH => "Západná Sahara",
			...
			:HT => "Haiti",
			:HU => "Maďarsko",
			:IC => "Kanárske ostrovy; [draft=contributed]",
			:ID => "Indonézia",
			:IE => "Írsko",
			:IL => "Izrael",
			:IM => "Ostrov Man",
			...
			:MK => "Macedónsko",
			:MK => "Macedónsko [FYROM]; [draft=contributed]",
			:ML => "Mali",
			:MM => "Mjanmarsko",
			:MN => "Mongolsko",
			:MO => "Macao OAO Číny",
			...
			:TK => "Tokelau",
			:TL => "Východný Timor",
			:TL => "Východný Timor; [draft=contributed]",
			:TM => "Turkménsko",
			:TN => "Tunisko",
			:TO => "Tonga",
			:TR => "Turecko",
